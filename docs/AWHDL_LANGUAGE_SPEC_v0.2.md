...
[Runtime semantics](RUNTIME_SPEC.md) and
[IR specification](IR_SPEC.md) are normative for execution identity
...
See [migration and implementation limits](MIGRATION_PHASE_1.md).
...
events with equal payloads remain distinct. [Runtime spec](RUNTIME_SPEC.md)
and [IR spec](IR_SPEC.md) are normative and take precedence in this scope.
...
remain unimplemented. See [migration and limits](MIGRATION_PHASE_2.md).
...
idempotency key stable for the same action instance. [Runtime spec](RUNTIME_SPEC.md)
and [IR spec](IR_SPEC.md) are normative and take precedence in this scope.
...
See [migration and limits](MIGRATION_PHASE_3.md).
...
[migration and limits](MIGRATION_PHASE_4.md).
...
[migration and limits](MIGRATION_PHASE_5.md).
...
[migration and limits](MIGRATION_PHASE_6.md).

## Phase 7 v0.1 profile (2026-09-23)

The v0.1 implementation scope and feature status are defined only by
[PROFILE_v0.1](PROFILE_v0.1.md). This specification describes the
